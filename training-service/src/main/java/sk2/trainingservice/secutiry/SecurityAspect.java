package sk2.trainingservice.secutiry;

import sk2.trainingservice.secutiry.service.TokenService;
...
public class SecurityAspect {
    ...
    @Around("@annotation(sk2.trainingservice.secutiry.CheckSecurity)")
